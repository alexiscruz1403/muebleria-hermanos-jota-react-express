    ...
    <header className="sticky top-0 z-10 bg-[#F5E6D3]">
      <nav className="flex justify-between items-center p-2 md:p-4">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <h1 className="text-[#A0522D] text-center font-['Playfair Display'] tracking-widest">
            HERMANOS JOTA
          </h1>
        </div>
        ...
        <ul
          className={`bg-[#C47A6D] md:bg-transparent absolute md:relative top-12 md:top-0 right-0 p-2 ${
            menuActivate
              ? "flex flex-col md:flex-row gap-2 rounded-md shadow-md md:rounded-none md: shadow-none"
        ...
        >
          ...
          {isAuthenticated && (
            <>
              ...
              <button
                className="md:hidden w-full text-left px-3 text-[#F5E6D3] py-2 hover:bg-[#A85F52] transition-colors font-semibold"
        ...
        <ul className="hidden md:flex items-center">
          {isAuthenticated ? (
            ...
            <div className="flex flex-col md:flex-row gap-2 items-center justify-center">
              <Link
                to="/login"
                className="px-5 py-2 bg-[#A0522D] text-[#F5E6D3] rounded-md hover:bg-[#8B3E20] hover:text-gray-100 transition-colors duration-300 shadow-sm"
              >
                Iniciar sesion
              </Link>
              <Link
                to="/registro"
                className="px-5 py-2 bg-[#87A96B] text-[#F5E6D3] rounded-md hover:bg-[#6F8C56] hover:text-gray-100 transition-colors duration-300 shadow-md"
              >
                Registrarse
              </Link>
            </div>
